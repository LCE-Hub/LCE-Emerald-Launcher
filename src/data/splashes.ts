export const SPLASHES = [
  ...
  "neoapps is cool!", //neo: i dont think so lmao
  "neoapps put a self-insert in this!",
  "Also try neoLegacy!",
  "$20 is $20",
  "no RenderDragon!",
  "Iggy Jiggy",
  ...
  "The shortest sentence scientifically possible.",
  "Must... Not... Report... To Microslop!!...",
  "Use a bass amp for an electric guitar!",
  "Never piss too hard",
  "This text contains 44 letters",
  "Infinity + 1, Dork!",
  "Gold is useless if you think about it",
  "(Kissing sounds)",
  "You look like my best friend, I feel gay",
